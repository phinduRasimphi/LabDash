...
namespace LabDash.Migrations
{
    ...
    [Migration("20260803193253_UpdateLabSchema")]
    partial class UpdateLabSchema
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LabDash.Models.SampleReceive", b =>
                {
                    ...
                    b.Property<int?>("TestRequestRequestId")
                        .HasColumnType("int");

                    b.HasKey("SampleReceptionId");

                    b.HasIndex("TestRequestRequestId");

                    b.ToTable("SampleReceive");
                });
            ...
            modelBuilder.Entity("LabDash.Models.SampleReceive", b =>
                {
                    b.HasOne("LabDash.Models.TestRequest", "TestRequest")
                        ...
                        .HasForeignKey("TestRequestRequestId");
